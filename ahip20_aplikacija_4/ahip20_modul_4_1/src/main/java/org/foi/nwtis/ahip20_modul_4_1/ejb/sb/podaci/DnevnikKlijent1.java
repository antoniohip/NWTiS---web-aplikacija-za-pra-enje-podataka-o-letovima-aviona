 ...
 * USAGE:
 * <pre>
 *        DnevnikKlijent1 client = new DnevnikKlijent1();
...
public class DnevnikKlijent1 {
     ...
     */
    public <T> T dajZapise(Class<T> responseType, String odVrijeme, String doVrijeme, String pomak, String stranica, String korisnik, String lozinka) throws ClientErrorException {
        String[] queryParamNames = new String[]{"odVrijeme", "doVrijeme", "pomak", "stranica"};
        String[] queryParamValues = new String[]{odVrijeme, doVrijeme, pomak, stranica};
        ;
