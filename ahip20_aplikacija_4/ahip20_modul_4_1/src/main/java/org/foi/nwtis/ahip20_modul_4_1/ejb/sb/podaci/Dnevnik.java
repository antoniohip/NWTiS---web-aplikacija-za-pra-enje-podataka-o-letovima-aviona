...
public class Dnevnik {
    ...
    public Dnevnik(int id,String korisnik, String zahtjev, String odgovor, long vrijemeZahtjeva) {
        this.id=id;
    ...
    public long getVrijemeZahtjeva() {
        return vrijemeZahtjeva;
    }

    public void setVrijemeZahtjeva(long vrijemeZahtjeva) {
        this.vrijemeZahtjeva = vrijemeZahtjeva;
    }
